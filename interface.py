...
import cv2
import math
from CNN import detect_face_predict
import time
...
def dete_tired(frame):
    ...
    flag=detect_face_predict(frame)
    ...
    mar = ''
    ear = ''
    global COUNTER, TOTAL, mCOUNTER, mTOTAL, hCOUNTER, hTOTAL,fCOUNTER
    ...
    for rect in rects:
        ...
        cv2.putText(frame,'FATIGUEDET:{}'.format(str(flag)),
    ...
    # if TOTAL >= 50 or mTOTAL >= 10 or hTOTAL >=5:
    if sum(fCOUNTER)>25:
        cv2.putText(frame, "WARNING:SLEEP!!!", (100, 200),
                    cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 255), 3)
        
    # print("=========>")
    # print( TOTAL, mTOTAL, mCOUNTER)

    return frame, hCOUNTER, TOTAL, mTOTAL, mCOUNTER, hTOTAL
